...
// PATCHED: Use Extract<keyof T, string> instead of keyof T for Omit
export declare type Omit<T, K extends Extract<keyof T, string>> = Pick<T, Diff<Extract<keyof T, string>, K>>;
